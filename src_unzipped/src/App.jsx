...
export default function App() {
  ...
  const [showProductionStart, setShowProductionStart] = useState(() => {
    return Boolean(localStorage.getItem("fabrimotor-current-user")) && !localStorage.getItem("startupPiece");
  });
  ...
  const buildSheetId = (data) => {
    ...
    return `${data.fecha}__${data.turno}__${data.maquina}`;
  };
