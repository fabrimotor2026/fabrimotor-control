...
export default function App() {
  ...
  const numeroSemana = Math.ceil(
    ((fechaEtiqueta - new Date(fechaEtiqueta.getFullYear(), 0, 1)) / 86400000 +
    new Date(fechaEtiqueta.getFullYear(), 0, 1).getDay() +
    1) /
    7
  );
...
Tiempo restante aproximado: ${hyundaiWaitInfo.remainingMinutes} minutos.`
  ...
  XLSX.utils.book_append_sheet(workbook, worksheet, "Control cajas F-1012");
  XLSX.writeFile(workbook, "control_cajas_f1012.xlsx");
};
      ...
      <div className="mt-4">
        ...
        <div className="mt-6 scale-75 origin-top rounded-2xl border-4 border-black bg-white p-4 text-black">
          ...
          <div className="mt-4 grid grid-cols-3 gap-2 text-center text-3xl font-black">
            ...
            <div className="border border-black py-2">{labelForm.fab1 || "-"}</div>
            <div className="border border-black py-2">{labelForm.col1 || "-"}</div>
            <div className="border border-black py-2">{labelForm.cant1 || "-"}</div>
            
            <div>FAB.</div>
            <div>COL.</div>
            <div>CANT.</div>
            
            <div className="border border-black py-2">{labelForm.fab2 || "-"}</div>
            <div className="border border-black py-2">{labelForm.col2 || "-"}</div>
            <div className="border border-black py-2">{labelForm.cant2 || "-"}</div>
          </div>
